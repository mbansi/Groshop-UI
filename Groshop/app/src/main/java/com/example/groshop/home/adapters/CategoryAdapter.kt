...
class CategoryAdapter(private val categories: ArrayList<CategoryModel>, private val fragment: HomeFragment): RecyclerView.Adapter<CategoryAdapter.ViewHolder>() {
